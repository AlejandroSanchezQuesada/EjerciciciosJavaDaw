...
import practicandojdbcjpafinal.Empleados;
...
public class EmpleadosJpaController implements Serializable {
    ...
    public List<Empleados> findEmpleadosTodos(){
        EntityManager em = getEntityManager();
        Query q = em.createNamedQuery("Empleados.findAll");
    ...
    public List<Empleados> findEmpleadoPorIdEmpleado(int _idEmpleado){
        EntityManager em = getEntityManager();
        Query q = em.createNamedQuery("Empleados.findByIdEmpleado");
        q.setParameter("idEmpleado", _idEmpleado);
        return q.getResultList();
